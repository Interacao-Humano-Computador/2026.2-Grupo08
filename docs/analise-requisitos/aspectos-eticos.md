...
| [Vinicius Silva Araruna](https://github.com/ViniciusA05) | [Estruturação integral do documento, redação da minuta do TCLE e ancoragem na literatura](#termo-de-consentimento-livre-e-esclarecido-tcle) | 26/09/2026 | Suporte na estruturação Markdown e tabelas |
...
O foco central deste trabalho é a análise de requisitos e tarefas dos usuários do **Fórum Diolinux Plus**. Conforme enfatizado por Barbosa e Silva (2021, p. 140-143), qualquer investigação científica ou prática em IHC que envolva a participação direta ou indireta de pessoas (através de questionários online, entrevistas, observações de campo ou testes de usabilidade) deve ser rigorosamente pautada pelo respeito à dignidade humana, integridade física e psicológica, transparência de propósitos e garantia irrestrita de privacidade.
...
| :--- | :--- | :--- |
| **Princípio da Autonomia** | Respeito ao direito de autodeterminação do indivíduo, que deve decidir livremente sobre sua participação após receber todos os esclarecimentos necessários (*Barbosa & Silva, 2021, p. 141*). | O participante decide voluntariamente responder ao questionário ou participar da entrevista; é livre para recusar perguntas ou interromper a sessão a qualquer instante sem necessidade de justificativa e sem qualquer penalidade. |
...
Para todas as coletas de dados qualitativas e quantitativas, disponibiliza-se a minuta textual completa do Termo de Consentimento Livre e Esclarecido, adaptada a partir da estrutura canônica proposta por Barbosa e Silva (2021, p. 142).

A Tabela 2 apresenta o modelo oficial do TCLE adotado pelo Grupo 08 para aplicação nos questionários e entrevistas com usuários do Fórum Diolinux Plus.
...
| **Procedimentos da Coleta** | A pesquisa envolverá o preenchimento de um formulário online e/ou a realização de entrevista síncrona com duração média de 15 a 20 minutos, abordando questões relativas à sua experiência com o ecossistema Linux, familiaridade com o fórum, hábitos de busca e publicação de dúvidas técnicas. |
...
| **Declaração de Consentimento** | De posse de todas as informações acima descritas, declaro que compreendi os objetivos e as garantias da pesquisa:<br><br>**( &nbsp; ) Dou meu consentimento livre e esclarecido para a realização da pesquisa e gravação.**<br>**( &nbsp; ) Não consinto com a realização da pesquisa.** |
