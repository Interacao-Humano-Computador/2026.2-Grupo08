...
Na primeira fase do projeto, os estudantes avaliaram individualmente websites focando no escopo da disciplina de Interação Humano-Computador. Cada aluno fez uma breve avaliação do site escolhido, e depois houve discussões em grupo para determinar qual site seria trabalhado, garantindo que a opção final atendesse a todos os critérios pedagógicos.
...
- O website apresenta questões graves de usabilidade.
- O website pertence ao governo ou possui domínio público (software livre/conteúdo aberto).
- Os usuários do website podem acessá-lo facilmente (público universitário abrangente).
