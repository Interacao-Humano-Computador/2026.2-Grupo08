...
Este artefato formaliza o **Cronograma Planejado** do projeto de Interação Humano-Computador (IHC) do Grupo 08, estruturado com base nas diretrizes pedagógicas e no cronograma oficial de aulas da disciplina ministrada pelo Prof. Dr. André Barros de Sales (Universidade de Brasília - Faculdade UnB Gama, 2026.2).

O objetivo deste documento é estabelecer a distribuição temporal das entregas, o balanceamento de esforço entre os cinco integrantes da equipe, a definição das janelas reservadas para a gravação audiovisual das apresentações e a previsão obrigatória de períodos para revisão e ajustes nos artefatos pós-feedback do professor e monitores, cobrindo integralmente as oito etapas do projeto ao longo de todo o semestre letivo.

---

## Etapa 1: Planejamento do Projeto e Processo de Design

A Tabela 1 apresenta as atividades planejadas para a primeira etapa do projeto.
...
| :--- | :---: | :--- | :---: | :--- |
| Documentar Equipe (sem matrícula e com fotos) | 03/09 - 04/09 | Pedro Paulo | 04/09 - 05/09 | Gustavo Antonio |
| Heatmap de Disponibilidade | 03/09 - 04/09 | Pedro Paulo | 04/09 - 05/09 | Jonathan Carpaneda |
| Ferramentas do Projeto | 04/09 - 05/09 | Vinicius Araruna, Jonathan Carpaneda | 05/09 - 06/09 | Pedro Paulo |
| Sites Avaliados e Matriz de Decisão | 03/09 - 05/09 | Gustavo Antonio, Vinicius Araruna | 05/09 - 06/09 | Edvaldo Soares |
| Site Selecionado (Portal Domínio Público) | 03/09 - 04/09 | Gustavo Antonio | 04/09 - 05/09 | Pedro Paulo |
| Processo de Design (Mayhew e Justificativa) | 04/09 - 06/09 | Vinicius Araruna | 06/09 | Pedro Paulo |
...
## Etapa 3: Princípios Gerais de Projeto, Metas de Usabilidade e Guia de Estilo

A Tabela 3 apresenta o planejamento da Etapa 3 (Fase de Análise de Requisitos segundo o Ciclo de Mayhew).

**Tabela 3** — Cronograma planejado da Etapa 3

| Atividade / Artefato | Período Planejado para Desenvolvimento | Autores | Período Planejado para Revisão | Revisores |
| :--- | :---: | :--- | :---: | :--- |
| Características da Plataforma do Projeto | 28/09 - 01/10 | Edvaldo Soares, Gustavo Antonio | 01/10 - 02/10 | Pedro Paulo, Vinicius Araruna |
| Princípios Gerais de Projeto de IHC | 29/09 - 02/10 | Edvaldo Soares, Jonathan Carpaneda | 02/10 - 03/10 | Gustavo Antonio, Pedro Paulo |
...
A Tabela 4 organiza o planejamento das avaliações formativas iniciais da solução interativa.

**Tabela 4** — Cronograma planejado da Etapa 4

| Atividade / Artefato | Período Planejado para Desenvolvimento | Autores | Período Planejado para Revisão | Revisores |
| :--- | :---: | :--- | :---: | :--- |
| Planejamento da Avaliação do Storyboard (DECIDE) | 01/10 - 06/10 | Vinicius Araruna, Pedro Paulo | 07/10 - 08/10 | Edvaldo Soares, Gustavo Antonio |
| Planejamento do Relato da Avaliação do Storyboard | 02/10 - 07/10 | Edvaldo Soares, Gustavo Antonio | 08/10 - 09/10 | Vinicius Araruna, Jonathan Carpaneda |
| Planejamento da Avaliação da Análise de Tarefas | 03/10 - 08/10 | Gustavo Antonio, Jonathan Carpaneda | 09/10 - 10/10 | Pedro Paulo, Edvaldo Soares |
...
## Etapa 5: Relato do Storyboard/Tarefas e Planejamento do Protótipo de Papel

A Tabela 5 detalha a execução dos relatos formativos e a preparação para a prototipação de baixa fidelidade.

**Tabela 5** — Cronograma planejado da Etapa 5

| Atividade / Artefato | Período Planejado para Desenvolvimento | Autores | Período Planejado para Revisão | Revisores |
| :--- | :---: | :--- | :---: | :--- |
| Execução e Relato da Avaliação do Storyboard | 13/10 - 18/10 | Vinicius Araruna, Jonathan Carpaneda | 19/10 - 20/10 | Edvaldo Soares, Pedro Paulo |
| Execução e Relato da Avaliação da Análise de Tarefas | 13/10 - 18/10 | Edvaldo Soares, Gustavo Antonio | 19/10 - 20/10 | Vinicius Araruna, Jonathan Carpaneda |
| Planejamento da Avaliação do Protótipo de Papel | 16/10 - 21/10 | Pedro Paulo, Vinicius Araruna | 21/10 - 22/10 | Gustavo Antonio, Edvaldo Soares |
...
## Etapa 6: Relato do Protótipo de Papel e Planejamento da Alta Fidelidade

A Tabela 6 organiza a transição dos protótipos de baixa fidelidade para a prototipação interativa em alta fidelidade.

**Tabela 6** — Cronograma planejado da Etapa 6
...
## Etapa 7: Relato dos Resultados da Avaliação da Alta Fidelidade

A Tabela 7 estrutura o desenvolvimento do protótipo de alta fidelidade e os testes empíricos com usuários.

**Tabela 7** — Cronograma planejado da Etapa 7
...
## Etapa 8: Verificação dos Artefatos e Entrega Final

A Tabela 8 apresenta a fase final de garantia da qualidade, verificação dos artefatos e consolidação do projeto.

**Tabela 8** — Cronograma planejado da Etapa 8 e Entrega Final
...
Durante a estruturação e organização do cronograma planejado ao longo das oito etapas da disciplina, foi utilizado apoio de Inteligência Artificial Generativa (LLM) para auxílio na padronização sintática de Markdown e formatação visual das tabelas. Toda a parametrização de datas, alocação de artefatos conforme o plano de ensino e divisão balanceada de tarefas entre os membros foram elaboradas, calculadas e validadas pelo autor.
